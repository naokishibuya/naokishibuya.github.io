...
Historically, researchers used RNNs (Recurrent Neural Networks) to keep track of ordinal dependencies in sequential data. Later, researchers incorporated [attention mechanism](/blog/2021/2021-09-29-neural-machine-translation-with-attention-mechanism/) into RNN encoder-decoder architectures to better extract contextual information for each word.
