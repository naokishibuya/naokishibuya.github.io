...
Let’s also define the absolute value of the largest [eigenvalue](/blog/2021/2021-08-31-matrix-decomposition-demystified/) of the weight matrix $W_h$ as $\lambda$ to see the conditions for the vanishing and exploding gradients based on how $\gamma$ and $\lambda$ affect the following Jacobian matrix:
...
We call the whole thing an LSTM cell (or block). We can replace the basic RNN hidden state calculation with an LSTM cell to form a complete recurrent neural network. Some RNN patterns are explained in [the previous article](/blog/2021/2021-09-20-recurrent-neural-networks/), where we can drop the LSTM cell in.
...
- [Recurrent Neural Networks](/blog/2021/2021-09-20-recurrent-neural-networks/)
