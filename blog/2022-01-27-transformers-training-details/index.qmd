...
[The previous article](/blog/2022/2022-01-23-transformers-data-loader/) discussed the implementation of a data loader for training a model based on the transformer architecture from [Attention Is All You Need](https://arxiv.org/abs/1706.03762) by Ashish Vaswani et al.
...
For details of the BLEU score, please look at [this article](/blog/2021/2021-10-20-bleu-bi-lingual-evaluation-understudy/).
...
We load the training dataset with `split = 'train'` and pass it to the train function. Please look at [this article](/blog/2022/2022-01-23-transformers-data-loader/) for the details of the data loader.
...
I’ll write about the translator in [the next article](/blog/2022/2022-01-31-transformers-evaluation-details/)
