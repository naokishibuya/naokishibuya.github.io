...
The latter half of the paper title is **with Conditional Adversarial Networks**, which indicates the use of a [CGAN (Conditional GAN)](/blog/2022-04-28-conditional-gan-2/). CGAN is an extension of [GAN](/blog/2022-04-21-gangenerative-adversarial-network-simple-implementation-with-pytorch/) that generates images satisfying conditions given to the generator network. 
...
So, this is nothing new. We've discussed a discriminator with convolutional layers in the [DCGAN](/blog/2022-04-22-dcgan-deep-convolutional-gan-generates-mnist-like-images-with-dramatically-better-quality/) and [CGAN](/blog/2022-04-28-conditional-gan-2/) articles. Convolutional layers work a lot better than the **fully-connected-layer-only** version to extract features from images.
...
- [CGAN (Conditional GAN): Specify What Images To Generate With 1 Simple Yet Powerful Change](/blog/2022-04-28-conditional-gan-2/)
