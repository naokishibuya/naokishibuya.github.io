...
Beam search is a heuristic technique for choosing the most likely output used by probabilistic sequence models like [neural machine translation](/blog/2021-09-29-neural-machine-translation-with-attention-mechanism/).
...
For simplicity, we are not showing any attention mechanism or other details like [word embedding](/blog/2021-10-12-word-embedding-lookup/). Such details won’t change anything about how beam search works. Our discussion focuses on the method of choosing an output given the list of output probabilities.
