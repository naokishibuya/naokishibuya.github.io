...
BERT stands for **B**idirectional **E**ncoder **R**epresentations from **T**ransformers. As the name suggests, it generates representations using an encoder from Vaswani et al.’s [Transformer Architecture](/blog/2021-12-13-transformers-encoder-decoder/). However, there are notable differences between BERT and the original Transformer, especially in how they train those models.
