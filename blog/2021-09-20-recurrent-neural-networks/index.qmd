...
The [attention mechanism](/blog/2021-09-29-neural-machine-translation-with-attention-mechanism/) solves the problem by allowing the decoder to access any hidden states from the encoder based on what it needs to pay attention to.
